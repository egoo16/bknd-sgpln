...
const projectDescription = connection_1.default.define("projectDescription", {
    ...
    formulationProcessId: { type: sequelize_oracle_1.default.UUID, allowNull: false },
    projectTypeId: { type: sequelize_oracle_1.default.UUID, allowNull: false },
    complexityId: { type: sequelize_oracle_1.default.UUID, allowNull: false },
