...
exports.createPriorizationMatrix = exports.createAdmissionQuanty = exports.updateState = exports.getOneRequest = exports.getAllRequest = exports.createRequestSinafip = void 0;
...
function createPriorizationMatrix(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            let idSolicitud = req.params.id;
            if (idSolicitud) {
...
exports.createPriorizationMatrix = createPriorizationMatrix;
